        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <h6 class="box-subtitle">Add new products</h6>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name_fa" class="form-control" required data-validation-required-message="This field is required">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="code" class="form-control" required data-validation-required-message="This field is required">
                                                    </div>
                                                    @if($errors->has('code'))
                                                        <div class="form-control-feedback">
                                                            <small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="qty" class="form-control" required data-validation-required-message="This field is required">
                                                    </div>
                                                    @if($errors->has('qty'))
                                                        <div class="form-control-feedback">
                                                            <small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="tags" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                                @if($errors->has('tags'))
                                                    <div class="form-control-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="tags_fa" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="size" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                                @if($errors->has('size'))
                                                    <div class="form-control-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="size_fa" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="color" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                                @if($errors->has('color'))
                                                    <div class="form-control-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="color_fa" value="" data-role="tagsinput" placeholder="add tags"/></div>
                                                    +
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="selling_prize" class="form-control" required
                                                               data-validation-required-message="This field is required">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="excerpt" id="excerpt" class="form-control" required placeholder="Textarea text"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="excerpt_fa" id="excerpt" class="form-control" required placeholder="Textarea text"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="description_fa" name="description_fa" rows="10" cols="80"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="image" onchange="handleImage(this)" class="form-control" required></div>
                                                    @if($errors->has('image'))
                                                        <div class="form-control-feedback">
                                                            <small>
                                                                {{$errors->first('image')}}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-4">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="multi_img[]" id="multiImg" multiple class="form-control" required>
                                                    </div>
                                                    @if($errors->has('image'))
                                                        <div class="form-control-feedback">
                                                            <small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" name="special_deal" id="special_deal" value="1">
